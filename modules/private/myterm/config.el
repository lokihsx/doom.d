;;; private/term/config.el -*- lexical-binding: t; -*-
...
;;  :hook (vterm-mode . hide-mode-line-mode) ; modeline serves no purpose in vterm
  ...
  ;; add for auto quit window when specify vterm seesion was quit!
  (advice-add 'vterm--sentinel :after #'myterm-kill-window))
...
(after! eshell ; built-in
 ...
 ;; (add-hook 'eshell-mode-hook #'hide-mode-line-mode)
  ...
  ;; add for auto quit window when specify eshell seesion was quit!
  (advice-add 'eshell-life-is-too-much :after #'myterm-kill-window))
